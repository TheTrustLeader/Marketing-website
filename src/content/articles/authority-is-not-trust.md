---
title: "Authority is not trust: why compliance can hide a confidence gap"
seoTitle: "Authority is not trust: compliance can hide a gap"
description: "Authority can produce compliance without trust. Learn how a green status report can hide the confidence gap between following a role and trusting its holder."
eyebrow: "Authority, compliance and trust"
introduction: "People doing what a role requires does not prove they trust the person holding it. The difference appears when someone must bring bad news, disagree or act without being told."
author: "Scott Hunter"
...
related:
  - href: "/articles/qualification-opens-the-door/"
    ...
    description: "Follow borrowed trust into a client relationship."
  - href: "/articles/influence-and-manipulation/"
    title: "The difference between influence and manipulation"
    description: "Use a transparent-reason test for ethical influence."
  - href: "/knowledge-base/direct-borrowed-and-system-trust/"
    title: "Direct, borrowed and system trust"
    description: "See how a role can lend confidence before direct experience."
---
...
That's what a confidence gap looks like. Nothing wrong on the surface, every box ticked, and a team quietly deciding, person by person, how much of the truth you can be relied on to hear. Authority gets you the behaviour. Trust gets you the truth. The green report was never lying, exactly. It just wasn't about the project.
