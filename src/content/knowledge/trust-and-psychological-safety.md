---
title: "What is the difference between trust and psychological safety?"
description: "Trust and psychological safety are related, but they are not the same. Learn the difference and the behaviours that connect them."
eyebrow: "Trust and psychological safety"
introduction: "Trust is one person’s confidence in another with something they care about. Psychological safety is a shared belief that a group is safe for speaking up and taking interpersonal risks."
author: "Scott Hunter"
...
related:
  - href: "/knowledge-base/direct-borrowed-and-system-trust/"
    ...
    description: "See the three places confidence can come from."
    label: "Trust foundations"
  - href: "/knowledge-base/authenticity-and-trust/"
    title: "Does being authentic make people trust you?"
    description: "Understand why authenticity matters, but cannot carry trust alone."
    label: "Trust behaviour"
  - href: "/how-it-works/"
    title: "How Trust Leader turns the idea into practice"
    description: "Move from one relationship to a focused behaviour and evidence of change."
    label: "Platform"
---
